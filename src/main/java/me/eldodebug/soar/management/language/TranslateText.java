...
public enum TranslateText {
	...
	COMPACT("text.compact"), FOX("text.fox"), SELECT_BACKGROUND("text.selectbackground"), NIGHT("text.night"),
	...
	JAPANESE("text.japanese"), ENGLISH("text.english"), CHINESE("text.chinese"), CHINESE_TRADITIONAL("text.chinese_traditional"), POLISH("text.polish"),
	...
	CHAT_COPY("text.chatcopy.name"), CHAT_COPY_DESCRIPTION("text.chatcopy.description"), CLICK_TO_COPY("text.clicktocopy"), AFTER_COPY("text.aftercopy"),
